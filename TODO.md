...
- [x] In-app уведомления: лайк комментария и ответ (`comment_like`,
  `comment_reply`), переход из панели уведомлений к комментарию
  (`focus_comment_id`, подсветка ветки) — 2026-04
...
- [ ] **Динамические плейлисты**
    - [ ] "Weekly Top 50" (автоматически на основе прослушиваний).
    - [ ] "Забытые сокровища" (лайкнутое давно).
- [ ] **PWA Offline Mode (v2) [High Priority]**
    - [ ] Кэширование HLS чанков в Service Worker.
    - [ ] Надежный UI для офлайн-режима.
