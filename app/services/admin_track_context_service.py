...
Правила:
— 3–5 предложений на трек, всегда на русском языке
— Трек с меткой [RU]: акцент на российском культурном контексте, \
истории создания, значении для отечественной аудитории
— Трек с меткой [EN]: адаптируй для русскоязычной аудитории — \
переведи смысл/контекст, упомяни жанр и международное значение
— Используй genre как подсказку стиля; не придумывай факты если они неизвестны
