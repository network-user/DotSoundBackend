...
export function WeeklyMixView() {
  ...
  const shareUrl = `${window.location.origin}${import.meta.env.BASE_URL}weekly-mix`
  ...
  usePrefetchTracks(internalTracks ?? null, 'weekly_mix')
    ...
    <section className="view active">
      <div className="view-header">
        ...
        <div style={{ flex: 1 }}>
          ...
          <span className="hint">{t('weeklyMix.hint')}</span>
        </div>
        <button
          className="icon-btn"
          onClick={() => {
      ...
      {!loading && externalTracks.length > 0 && (
        <>
          <div className="section-header">
            <span className="section-title">{t('weeklyMix.discoveries')}</span>
          </div>
          ...
          <div className="share-modal scale-in">
            <div className="share-modal-header">
              <div className="share-modal-title-wrap">
                ...
                <p className="share-modal-subtitle">{t('weeklyMix.title')}</p>
              </div>
              <button
                type="button"
                className="icon-btn"
